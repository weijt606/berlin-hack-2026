...
export const defaultSettings = {
  ...
  vibePttKey: 'Space',
  vibeAutoApply: true,
  // Speech recognition language. 'auto' uses navigator.language (which on
  // Chinese-locale browsers picks zh-CN and butchers English prompts —
  // hence the en-US default).
  vibeVoiceLang: 'en-US',
};
