...
sources:
  ...
  - existing services/llm/src/prompts/strudel-system.md (seed prompt)
verification_policy:
...
It is consumed by the LLM in `services/llm/src/index.mjs` as a system prompt.
...
13. `examples/genres.md`
14. `examples/techniques.md`
15. `recipes/<intent>.md` (route by user request)
