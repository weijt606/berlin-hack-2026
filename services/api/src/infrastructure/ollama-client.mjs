 ...
 *
 * Thinking mode is disabled by default. Models like qwen3:8b are
 * thinking-capable and emit a long internal-monologue token stream before
 * any answer — fine for a research chat, useless for our live-coding loop
 * where we want sub-second code drops. Override via OLLAMA_THINK=true if
 * you actually want the chain-of-thought.
 *
 * @param {{
 *   baseUrl?: string,
 *   model: string,
